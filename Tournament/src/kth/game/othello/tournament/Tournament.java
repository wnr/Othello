...
/**
 * Class implementing a tournament for different move strategies. Can be used to just get the results
 * of the tournament, or to show the games in a gui first.
 */
public class Tournament {
    ...
    /**
     * Helper method for playing a game. Returns -1 if the first player wins, 1 if the second
     * player wins and 0 if it's a draw.
     */
